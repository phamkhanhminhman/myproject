	...
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
			...
			<!-- 			<div class="col-md-4 ftco-animate">
						...
						<div class="col-md-4 ftco-animate">
							<a href="images/3.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(images/3.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 03</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="images/5.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(images/5.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 05</h3>
									<span class="tag">Travel</span>
						...
						<div class="col-md-4 ftco-animate">
							<a href="images/6.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(images/6.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 06</h3>
									<span class="tag">Travel</span>
						...
						<div class="col-md-4 ftco-animate">
							<a href="images/7.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(images/7.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 07</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="images/8.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(images/8.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 08</h3>
									<span class="tag">Nature</span>
...
</html><?php /**PATH C:\xampp\htdocs\myproject\resources\views/test.blade.php ENDPATH**/ ?>